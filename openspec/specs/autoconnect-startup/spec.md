...
Persisted autoconnect toggle (default off) and a one-time connection attempt on launch when enabled, visible in the task center with success/failure notifications.
