...
public partial class App : Application
{
        ...
        Views.MobileSplashView splash)
    {
        ...
        await XBVault.Helpers.UIHelpers.RunOnUIAsync(async () =>
        {
            ...
            toolsViewModel.ShowCustomInstallAction = () => ShowMobileCustomInstall(main, authService, packageService, installService);
            browseViewModel.ShowCustomInstallAction = () => ShowMobileCustomInstall(main, authService, packageService, installService);
    ...
    private static async void ShowMobileCustomInstall(
