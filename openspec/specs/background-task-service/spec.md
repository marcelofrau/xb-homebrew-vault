...
Central background-work registry. Exposes one-shot tasks and recurring jobs with live state (progress, status, cancellation) so the UI can bind and the status bar can react to activity.
