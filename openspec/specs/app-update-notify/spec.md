...
Consolidated update notifications: one notification listing all updatable apps, each individually actionable, surfaced through the notification center so users can follow up after dismissal.
